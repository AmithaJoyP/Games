...
document.getElementById('round-result').textContent = `Player 1 chose ${choice}. Waiting for
Player 2...`;
} else if (player === 'player2') {
document.getElementById('player2').style.display = 'none';
document.getElementById('round-result').textContent = `Player 2 chose ${choice}.
Calculating result...`;
fetch('/play', {
method: 'POST',
headers: {
...
document.getElementById('round-result').textContent = `Player 1 chose
${playerChoices.player1}, Player 2 chose ${playerChoices.player2}. ${data.result}`;
...
document.getElementById('result').textContent = `Final Score: Player 1- ${player1Wins},
